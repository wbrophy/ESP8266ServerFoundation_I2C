...
String strRootHTML = strHttpResponseHead + "<body>" "\n"
                     ...
                     "}" "\n"
                     "function fnLabelDevice()" "\n"
                     "{" "\n"
                     "  let http = new XMLHttpRequest();" "\n"
                     "  let url = '/api/getnetwork';" "\n"
                     "  http.open('GET', url, true);" "\n"
                     "  http.onreadystatechange = function()" "\n"
                     "    {" "\n"
                     "      if(http.readyState == 4 && http.status == 200)" "\n"
                     "        {" "\n"
                     "          let divDeviceName = document.getElementById('DeviceName');" "\n"
                     "          let sd = JSON.parse(http.responseText);" "\n"
                     "          divDeviceName.innerText = sd.hostname;" "\n"
                     "        }" "\n"
                     "      }" "\n"
                     "  http.send();" "\n"
                     "}" "\n"
                     ...
                     "</script>" "\n"
                     "<style>" "\n"
                     "a[id=goButton] {font-size: 16vw; text-decoration: none; border: 3px solid grey; border-radius: 20%;}" "\n"
                     "p {text-align: center;}" "\n"
                     "select[id=selector] {font-size: 8vw; width: 90vw;}" "\n"
                     "div[id=DeviceName] {font-size: 4vw; position: absolute;top: 2%;left: 2%;}" "\n"
                     ...
                     "<option value='/api/getnetwork'>Get Network</option>" "\n"
